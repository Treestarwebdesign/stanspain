...
get_header(); ?>
                            ...
                            <div class="product-details">
                                ...
                                <?php if ($product_set != "platform-lift") : ?>
                                    <div class="product-keybenefits">
                                        <h3><?php _e('Key benefits:','stannah-whitelabel'); ?></h3>
                                        <?php the_field('key_features_listing'); ?>
                                    </div>

                                    <div class="product-suitability">
                                        <h3><?php _e('Suitable for:','stannah-whitelabel'); ?></h3>
                               ...
                               <?php else : ?>
                                ...
                                <?php if (have_rows('customisable_options')) : ?>
                                    <div class="product-styles">
                                        <h3><?php _e('Styling options:','stannah-whitelabel'); ?></h3>
    ...
    <!-- 3 steps -->
    <?php if ( $product_set != "platform-lift" &&  get_field('step_1_blurb', 'option')) : ?> 
                        ...
                        <div class="steps-holder row">
                            <div class="col-sm-4">
                                ...
                                <div class="step">
                                    ...
                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/step-icon-phone.png" alt="Step 1" />
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="step">
                                    ...
                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/step-icon-doc.png" alt="Step 2" />
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="step">
                                    ...
                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/step-icon-spanner.png" alt="Step 3" />
